...
spx_integrity_check( 1 === preg_match( '/^[ \t]*\*[ \t]+Version:[ \t]+0\.9\.0-rc\.10[ \t]*$/m', $main ), 'plugin header is 0.9.0-rc.10' );
spx_integrity_check( false !== strpos( $main, "define( 'SPX_WC_VERSION', '0.9.0-rc.10' );" ), 'runtime version is 0.9.0-rc.10' );
spx_integrity_check( false !== strpos( $blocks, "version: '0.9.0-rc.10'" ), 'Blocks integration version is 0.9.0-rc.10' );
spx_integrity_check( false !== strpos( $readme, '`0.9.0-rc.10`' ), 'README version is 0.9.0-rc.10' );
spx_integrity_check( false !== strpos( $guide, 'spx-express-woocommerce-0.9.0-rc.10.zip' ), 'Vietnamese guide uses the rc.4 package name' );
spx_integrity_check( false !== strpos( $changelog, '## 0.9.0-rc.10' ), 'changelog starts the rc.4 release record' );
spx_integrity_check( false !== strpos( $pot, '0.9.0-rc.10' ) && false !== strpos( $po, '0.9.0-rc.10' ), 'translation catalog headers use rc.4' );
