...
final class SPX_Admin_Settings_Page {
	...
	private static function render_overview(): void {
		...
		$verified_now = class_exists( 'SPX_Production_Verification_Store' ) && SPX_Production_Verification_Store::is_verified( SPX_Production_Gate::current_fingerprint(), SPX_Environment::host( 'production' ) );
		$fee_status   = $verified_now ? __( 'Phí do SPX tính', 'spx-express-woocommerce' ) : __( 'Phí dự phòng của shop', 'spx-express-woocommerce' );
		self::overview_card( __( 'Phí giao hàng', 'spx-express-woocommerce' ), $fee_status, $verified_now ? 'success' : 'neutral', __( 'Cấu hình phí', 'spx-express-woocommerce' ), 'rates' );
