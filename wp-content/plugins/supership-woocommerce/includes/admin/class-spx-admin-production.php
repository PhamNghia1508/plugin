...
final class SPX_Admin_Production {
	...
	public static function render_section(): void {
		...
		echo '<p>' . esc_html__( 'Kết nối SPX chưa được xác minh.', 'spx-express-woocommerce' ) . '</p><p>' . esc_html__( 'Thông tin kết nối cần được SPX xác nhận trước khi tính phí hoặc tạo vận đơn.', 'spx-express-woocommerce' ) . '</p><p>' . esc_html__( 'Vui lòng cập nhật thông tin kết nối mới và xác minh lại sau khi SPX cấp lại User Secret.', 'spx-express-woocommerce' ) . '</p>';
